...
const (
	QueryHostInsert = `INSERT INTO db_terminal.host (id,name,url,port,host_username,host_password,host_client_id,host_type,topic) VALUES ($1,$2,$3,$4,$5,$6,$7,$8,$9) returning id`
